...
//    public static final String BROKER_URL = ActiveMQConnection.DEFAULT_BROKER_URL;
    public static final String BROKER_URL = "tcp://192.168.80.32:61616";
        ...
        try {
            ...
            messageConsumer.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message message) {
                    try {
                        System.out.println("GG消费者1 接收到消息：" + ((TextMessage) message).getText());
            ...
            messageConsumer2.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message message) {
                    try {
                        System.out.println("GG消费者2 接收到消息：" + ((TextMessage) message).getText());
                    } catch (JMSException e) {
                        e.printStackTrace();
                    }
                }
            ...
            messageConsumer3.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message message) {
                    try {
                        System.out.println("GG消费者3 接收到消息：" + ((TextMessage) message).getText());
                    } catch (JMSException e) {
                        e.printStackTrace();
                    }
                }
